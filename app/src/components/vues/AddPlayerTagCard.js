  ...
  render() {
    return (
      <div className="tagCard">
        ...
        <input type="text" value={this.props.player.nameTag} onChange={e => this.props.onChangeHandler({value: e.target.value, id: this.props.player.key})} name={"player" + this.props.player.key} placeholder="#NAMETAG" maxLength="8"/>
